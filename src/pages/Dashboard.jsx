...
export default function Dashboard({ onNavigate }) {
  return <>
    <div className="stats">
      ...
      <div className="stat"><div className="label">Créances sociétés</div><div className="value" style={{color:'#ef4444'}}>42.8M Ar</div><div className="sub" style={{color:'#f59e0b'}}>Société Alpha: 28.5M</div></div>
    ...
    <div className="grid2">
      <div className="card">
        ...
        <table className="tbl">
          ...
          <tbody>
            <tr onClick={()=>onNavigate('/vente-societe')}><td>01/07</td><td>RAKOTO Jean</td><td>Société Alpha</td><td style={{color:'#10b981'}}>45 600 Ar</td></tr>
            <tr onClick={()=>onNavigate('/vente-societe')}><td>01/07</td><td>RABE Marie</td><td>Société Alpha</td><td style={{color:'#10b981'}}>128 000 Ar</td></tr>
            <tr onClick={()=>onNavigate('/vente-societe')}><td>30/06</td><td>ANDRIA Paul</td><td>Société Beta</td><td style={{color:'#10b981'}}>67 200 Ar</td></tr>
            <tr onClick={()=>onNavigate('/vente-societe')}><td>30/06</td><td>RASOA Hery</td><td>Société Alpha</td><td style={{color:'#10b981'}}>312 500 Ar</td></tr>
          </tbody>
        </table>
        </div>
      </div>
      ...
      <div>
        <div className="card">
          ...
          <div className="alert alert-y"><Clock size={14}/> Facturation Société Alpha — Juin en attente</div>
          <div className="alert alert-g"><Building2 size={14}/> Société Beta — facture Mai payée</div>
        </div>
        <div className="card">
